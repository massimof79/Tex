...
\begin{block}{Monte ore su 5 anni (tradizionale)}
32 h/settimana × 33 settimane × 5 anni = \textbf{5.280 ore}
\end{block}

\begin{block}{Rimodulazione su 4 anni}
	\begin{itemize}
		\item 40 h/settimana × 33 settimane × 4 anni = \textbf{5280 ore} - di cui -
...
5.280 -- 4.752 = \textbf{528 ore} da distribuire con modalità innovative
\end{alertblock}
...
\begin{frame}{Ore da redistribuire}
	\vspace{0.3cm}
	\small
	\textit{Le 528 ore saranno redistribuite attraverso:}
	\begin{itemize}
...
\begin{frame}{Distribuzione delle 5281 Ore su 4 Anni}
\small
\begin{table}
\centering
...
\hline
\textbf{4° anno} & 1188 & 38h p.sett (di cui) 2h FAD pom. + 100h FSL + 198 potenz. \\
\hline
\rowcolor{lightgray}
\textbf{TOTALE} & \textbf{5281} & \\
\hline
\end{tabular}
\end{table}
...
\item[\checkmark] \textbf{Organico potenziato} (40/32 per classe, compresi ITP)
