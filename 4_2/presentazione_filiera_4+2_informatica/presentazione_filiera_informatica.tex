...
\begin{frame}{Rimodulazione monte ore su 4 anni}
\begin{block}{Rimodulazione su 4 anni}
	\begin{itemize}
		\item \textbf{5214 ore}
		\item 36 h/settimana (in media)× 35 settimane × 4 anni = \textbf{5040 ore frontali}
	   \item 5214-4752 = 174 residue 		 
	\end{itemize}
\end{block}

\vspace{0.3cm}
\begin{alertblock}{Ore da redistribuire}
\textbf{174 ore} da redistribuire in attività FSL e altre attività al di fuori dell'orario scolastico.
\end{alertblock}
...
\begin{frame}{Ore da redistribuire}
	\vspace{0.3cm}
	\small
	\textit{Le 174 ore saranno redistribuite attraverso:}
	\begin{itemize}
		\item Eventuali attività pomeridiane e FAD, sincrona/asincrona
		\item FSL potenziata
		\item Attività di progettazione in modalità Service Learning, Seminari, Workshop etc
	\end{itemize}
\end{frame}
...
\hline
\textbf{1° anno} & 1122 & 34h p.sett. \\
\hline
\textbf{2° anno} & 1221& 37h p.sett (di cui) 2h FAD pom.  \\
\hline
\textbf{3° anno} & 1221 & 37h p.sett (di cui) 2h FAD pom. 	\\
\hline
\textbf{4° anno} & 1188\ & 36h p.sett (di cui) 2h FAD pom. \\
\hline
\textbf{FSL e altre att.} & 174\ & \\
\hline
\rowcolor{lightgray}
...
Corso: \textit{Full Stack Developer} (sede di San Benedetto del Tronto)
\end{block}
