...
\onehalfspacing
\title{Verifica di TPSIT - 5 AINC - Compito C} 
...
\begin{document}
	...
	e del libro. (Host: 127.0.0.1  DBNAME: Biblioteca)
	...
	\begin{itemize}
		...
		\texttt{fetch} e ricevere dati in formato SON.
	...
	FRispondere ad una delle seguenti domande a tua scelta \textbf{2 pt}
	
	\begin{itemize}
		\item Domanda 1
		Che cosa sono i cookie in un sito web? Spiega a cosa servono e dove vengono memorizzati.
		
		\item Domanda 2
		Che cosa sono le sessioni nelle applicazioni web e che differenza c'è con i cookies? 
	\end{itemize}
