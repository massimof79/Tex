...
\onehalfspacing
\title{Verifica di TPSIT -  Classe 5AINC - Compito A}
...
\vspace{1cm  }
	...
	Realizzare una piccola applicazione web che consenta di inserire un nuovo cliente nella tabella \texttt{CLIENTI} tramite una pagina html (client) e un endpoint PHP (backend) che salvi i dati su MySQL. (Host: 127.0.0.1  DBNAME: Palestra)
	...
	\begin{itemize}
		...
		\item NB. Sicurezza: il backend deve usare query parametrizzate (PDO con prepared statements). 
	\end{itemize}
	...
	Realizzare una piccola applicazione web che consenta di visualizzare l'elenco delle iscrizioni di tutti i clienti, includendo anche le informazioni anagrafiche minime del cliente e, se presente, il corso associato. (Host: 127.0.0.1  DBNAME: Palestra)
