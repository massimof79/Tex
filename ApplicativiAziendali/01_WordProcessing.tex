...
\begin{document}
	...
	\begin{frame}{Obiettivi della lezione}
		In questa lezione impariamo a usare in modo corretto un programma di elaborazione testi, come quelli che utilizzi per relazioni, ricerche o compiti scritti.
		
		L’obiettivo non è solo “scrivere”, ma:
		\begin{itemize}
			\item gestire bene i documenti
			\item lavorare in modo ordinato e veloce
			\item modificare il testo senza perdere tempo
			\item conoscere strumenti che fanno risparmiare fatica
		\end{itemize}
		Queste competenze sono fondamentali in ambito scolastico e professionale.
	\end{frame}
	...
	\begin{frame}{Creare un nuovo documento}
		Quando inizi un nuovo lavoro puoi creare un documento vuoto oppure partire da un modello.
		
		I modelli sono documenti già strutturati (per esempio lettere, relazioni, curriculum) che ti aiutano a non partire da zero. Usarli significa lavorare in modo più rapido e con una formattazione già ordinata.
	\end{frame}
	...
	\begin{frame}{Salvare in formati diversi}
		...
		Puoi esportarlo in PDF per inviarlo o stamparlo senza che venga modificato, oppure in formato testo semplice (.txt) quando ti serve solo il contenuto senza formattazione. Scegliere il formato giusto dipende dallo scopo del documento.
	\end{frame}
	...
	\begin{frame}{Spostarsi tra documenti aperti}
		...
		Puoi passare da un documento all’altro usando la barra delle applicazioni, il menu del programma oppure scorciatoie da tastiera come Alt+Tab. Saperlo fare velocemente aumenta molto la produttività.
	\end{frame}
	...
	\begin{frame}{Impostazioni di base}
		Ogni programma permette di personalizzare alcune impostazioni.
	...
	\begin{frame}{Modalità di visualizzazione}
		...
		La modalità Layout di stampa mostra il documento come apparirà su carta. La modalità Bozza è più semplice e comoda per concentrarsi solo sul testo. La modalità Lettura è utile per consultare il contenuto.
	\end{frame}
	...
	\begin{frame}{Conclusione}
		Saper usare bene un programma di elaborazione testi non significa solo scrivere, ma lavorare con metodo.
		
		Gestire file, usare strumenti di modifica e conoscere le funzioni di supporto permette di risparmiare tempo, ridurre gli errori e produrre documenti più chiari e professionali.
	\end{frame}
