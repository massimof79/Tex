...
\begin{frame}
	\begin{itemize}
		\item 	La libreria SciPy è una raccolta di strumenti avanzati per il calcolo scientifico e ingegneristico in Python. 
		\item Si appoggia a NumPy e ne estende le funzionalità, offrendo algoritmi pronti all’uso, efficienti e ben collaudati.
		\item Algebra lineare
		\item Integrazione ed equazioni differenziali
		\item Statistica e Probabilità
	\end{itemize}
\end{frame}
