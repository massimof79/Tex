...
\begin{document}
	...
	Il modello \textbf{K-Nearest Neighbors} (KNN) è uno dei metodi più intuitivi dell'apprendimento automatico.
	
	L'idea di base è semplice: per fare una previsione su un nuovo dato, il modello osserva i dati già noti che gli somigliano di più.
	
	In altre parole:
	
	\begin{center}
		``Dimmi chi ti assomiglia e ti dirò chi sei''
	\end{center}
	...
	Possiamo rappresentare ogni studente come un vettore:
	...
	Ogni studente diventa quindi un punto nel piano cartesiano.
	
	Abbiamo un insieme di dati noti (dataset):
	...
	\begin{itemize}
		\item $\mathbf{x}_i$ = caratteristiche
		\item $y_i$ = risultato osservato (voto, esito, ecc.)
	\end{itemize}
	...
	La più usata è la distanza euclidea:
	...
	\begin{center}
		Il modello non impara una formula. Impara per analogia.
	\end{center}
