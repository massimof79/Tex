...
\begin{document}
	...
	La \textbf{regressione lineare} è uno degli algoritmi più importanti nel machine learning supervisionato. L'obiettivo è trovare una relazione lineare tra variabili indipendenti (features) e una variabile dipendente continua (target).
	...
	\begin{itemize}
		...
		\item $y_i$ è il valore reale della i-esima osservazione
		\item $n$ è il numero totale di osservazioni
		\item $\hat{y}_i$ è il valore previsto dal modello per la stessa osservazione.
		
		\item 	$(y_i - \hat{y}_i)^2$ è l’errore di previsione, elevato al quadrato.
	\end{itemize}
