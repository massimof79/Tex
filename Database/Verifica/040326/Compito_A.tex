...
\begin{document}
	...
	\begin{enumerate}
		\item Mostrare tutti i noleggi effettuati dal cliente con id\_cliente = 7 indicando id\_noleggio, targa, data\_inizio e data\_fine.
	...
	\begin{enumerate}
		...
		\item Targhe delle moto mai noleggiate.
		\item Coppie (cliente, targa) relative ai noleggi di febbraio 2026.
		\item Numero di noleggi per ciascuna moto.
		\item Clienti che hanno effettuato almeno un pagamento con esito positivo.
	\end{enumerate}
