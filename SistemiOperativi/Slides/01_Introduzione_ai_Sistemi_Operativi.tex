...
\end{verbatim}
	...
	\begin{frame}
		...
		\begin{itemize}
			\item usare il disco come buffer
			\item sovrapporre I/O ed elaborazione
		\end{itemize}
...
\begin{frame}
	...
	Nei sistemi batch semplici la CPU rimaneva spesso inattiva
...
\begin{frame}
	...
	Gli interrupt permettono al sistema operativo di reagire
...
\begin{frame}
	...
	La memoria principale è una risorsa limitata
...
\begin{frame}
	\frametitle{Esempio di struttura a livelli}
...
\begin{frame}
	...
	Nel modello microkernel
	solo le funzioni essenziali
	sono presenti nel kernel.
	
	Altre funzionalità vengono
	eseguite come processi separati.
...
\begin{frame}
	...
	\begin{itemize}
		\item maggiore modularità
		\item maggiore sicurezza
		\item maggiore affidabilità
	\end{itemize}
...
\begin{frame}
	\frametitle{Esempi di Sistemi Operativi}
