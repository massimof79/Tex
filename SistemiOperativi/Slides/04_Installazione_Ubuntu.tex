...
\title{Installazione di Ubuntu su VMware Workstation}
...
condividere con altri utenti
	...
	\begin{frame}
		\frametitle{Opzioni disponibili}
		
		Durante la creazione della macchina virtuale è possibile scegliere
		quale disco utilizzare:
		
		\vspace{0.5cm}
		
		\begin{itemize}
			\item Create a new virtual disk
			\item Use an existing virtual disk
			\item Use a physical disk (advanced)
		\end{itemize}
		...
		\begin{itemize}
			\item Stato del progetto (nuovo o esistente)
			\item Necessità di riutilizzo
			\item Livello di controllo richiesto
		\end{itemize}
	...
	\begin{frame}
		\frametitle{Creare un nuovo disco}
		
		\textbf{Create a new virtual disk}
		
		\begin{itemize}
			\item Crea un disco virtuale da zero
			\item Salvato come file sul sistema host
			\item Può essere spostato o copiato facilmente
		\end{itemize}
		...
		\textbf{Quando usarlo}
		\begin{itemize}
			\item Nuova installazione del sistema operativo
			\item Attività didattiche o di laboratorio
			\item Ambienti di test
		\end{itemize}
		...
		\textbf{Vantaggi}
		\begin{itemize}
			\item Semplicità e sicurezza
			\item Isolamento completo
		\end{itemize}
	...
	\begin{frame}
		\frametitle{Disco esistente o fisico}
		
		\textbf{Use an existing virtual disk}
		\begin{itemize}
			\item Riutilizza un disco già configurato
			\item Utile per macchine preconfigurate
		\end{itemize}
		...
		\textbf{Quando usarlo}
		\begin{itemize}
			\item Ripristino di VM
			\item Distribuzione di ambienti già pronti
		\end{itemize}
		
		\vspace{0.5cm}
		
		\textbf{Use a physical disk (advanced)}
		\begin{itemize}
			\item Accesso diretto a un disco reale
			\item Richiede privilegi amministrativi
		\end{itemize}
		...
		\textbf{Attenzione}
		\begin{itemize}
			\item Rischio di perdita dati
			\item Da usare solo in casi avanzati
		\end{itemize}
	...
	\begin{frame}
		\frametitle{Installazione Ubuntu - Lingua e localizzazione}
