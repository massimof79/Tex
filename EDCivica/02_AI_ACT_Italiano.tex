...
\item Effetto raggelante sulla libertà
\end{itemize}
\end{exampleblock}
...
% Slide 12: Categorie di Sistemi ad Alto Rischio - Parte 1
\begin{frame}{Sistemi ad Alto Rischio: Categorie Pratiche (1/2)}
\begin{columns}[T]
\column{0.48\textwidth}
...
\begin{itemize}
\item Determinazione accesso alle istituzioni
\item Valutazione risultati di apprendimento
\item Monitoraggio per disonestà negli esami
\end{itemize}
\end{block}

\column{0.48\textwidth}
\begin{block}{4. Occupazione}
\begin{itemize}
\item Sistemi di screening CV
\item Valutazione colloqui
\item Monitoraggio prestazioni
...
\begin{alertblock}{Filo Conduttore}
Tutti questi sistemi possono influenzare significativamente i diritti fondamentali e la sicurezza delle persone
\end{alertblock}
\end{columns}
\end{frame}

% Slide 13: Categorie di Sistemi ad Alto Rischio - Parte 2
\begin{frame}{Sistemi ad Alto Rischio: Categorie Pratiche (2/2)}
\begin{columns}[T]
\column{0.48\textwidth}
...
% Slide 15: Sistemi a Rischio Minimo
\begin{frame}{Rischio Minimo: La Maggioranza dei Sistemi IA}
\begin{tikzpicture}[remember picture,overlay]
...
\item Raccomandazioni acquisti online
...
\begin{itemize}
\item Nessun obbligo speciale
\item Nessuna valutazione di conformità
\item Nessuna burocrazia complessa
\end{itemize}
\end{block}

\column{0.48\textwidth}
\begin{block}{Misure Volontarie}
Adozione incoraggiata di:
\begin{itemize}
\item Codici di condotta
\item Best practice
\item Autoregolamentazione
\end{itemize}
\end{block}
...
\end{itemize}
Nessuna sovrapposizione normativa
\end{block}
\end{columns}
...
\begin{center}
\begin{tikzpicture}
\node[rectangle, draw, thick, fill=blue!20, minimum width=10cm, minimum height=0.8cm, align=center] {\textbf{Obiettivo: Prevenire manipolazione e proteggere la fiducia}};
\end{tikzpicture}
\end{center}
\end{frame}
...
% Slide 18: IA per Finalità Generali e Modelli Fondativi
\begin{frame}{IA per Finalità Generali e Modelli Fondativi}
...
\begin{columns}[T]
\column{0.48\textwidth}
\begin{block}{Differenza Chiave}
A differenza dell'IA a scopo specifico:
\begin{itemize}
...
% Slide 19: Modelli con Rischio Sistemico
\begin{frame}{Modelli con Rischio Sistemico}
...
\begin{columns}[T]
\column{0.48\textwidth}
\begin{alertblock}{Rischi Sistemici}
\begin{itemize}
\item Disinformazione di massa
\item Attacchi informatici coordinati
\item Manipolazione sociale
\item Guasti su larga scala
\item Conseguenze indesiderate
\end{itemize}
\end{alertblock}

\column{0.48\textwidth}
\begin{block}{Obblighi Richiesti}
\begin{itemize}
...
% Slide 23: Sanzioni - Parte 2
\begin{frame}{Sanzioni: Disposizioni Speciali}
\begin{columns}[T]
\column{0.48\textwidth}
\begin{block}{PMI e Startup}
\textbf{Trattamento speciale:}
\begin{itemize}
\item Si applica l'importo più basso dei due
\item Riconoscimento che multe elevate potrebbero essere devastanti
\item Principio di proporzionalità
\end{itemize}
\end{block}
...
\begin{itemize}
\item €35M o 7\% del fatturato
\item \textbf{Importo più basso} viene applicato
\end{itemize}
\end{exampleblock}

\column{0.48\textwidth}
\begin{block}{Istituzioni UE}
\textbf{Nessuna esenzione:}
\begin{itemize}
\item Agenzie UE soggette a multe
\item Il Garante Europeo della Protezione Dati può imporre sanzioni
\item Le regole si applicano a pubblico e privato allo stesso modo
\end{itemize}
\end{block}
...
\begin{itemize}
\item Diritto di presentare reclami
\item Autorità di vigilanza devono indagare
\item Procedure specifiche garantite
\end{itemize}
\end{block}
\end{columns}
