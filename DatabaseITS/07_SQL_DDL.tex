...
\begin{document}
	...
	\section{Politiche di reazione - Chiavi Esterne (Foreign Key)}

	\begin{frame}{Politiche di reazione}
	\begin{center}
	...
	\begin{frame}{Foreign Key - Notazioni}
		...
		\begin{itemize}
			...
			\item Per impostare le politiche di reazione su un database esistente, è necessario prima individuare le tabelle esterne (quelle con esistenza propria) e le tabelle interne ovvero quelle con le chiavi esterne.
			\item le politiche di reazione devono essere inserite nelle tabelle interne.
		\end{itemize}
	\end{frame}
