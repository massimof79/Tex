...
\title{Esercizio di preparazione al primo test di basi di dati}
\author{Prof. Fedeli Massimo}
\date{Lunedì  25 Gennaio 2026}
\begin{document}
	\maketitle
\begin{flushleft}
		\textbf{Cognome e Nome}: 
\end{flushleft}
	...
	\section*{Svolgimento}
		...
		\item Realizzare lo schema concettuale definitivo spiegando come è stata effettuata la ristrutturazione qualora sia stata necessaria.
		\item Scrivere lo schema logico mettendo bene in evidenza chiavi primarie e chiavi esterne. 
	\end{itemize}
