...
\begin{enumerate}[label=\alph*)]
    ...
    \item I nodi sono collegati in modo da formare idealmente una stella
...
\item Un computer Windows che non riesce a contattare il server DHCP assegna automaticamente a se stesso un indirizzo IP nel range:
\begin{enumerate}[label=\alph*)]
	\item 169.254.0.0/16 (APIPA - Automatic Private IP Addressing)
	\item 10.0.0.0/8 (rete privata di classe A)
	\item 192.168.0.0/16 (rete privata di classe C)
