...
\title[Filiera 4+2 Meccatronica]{Filiera Formativa Tecnologico-Professionale 4+2}
\subtitle{Indirizzo Meccanica, Meccatronica ed Energia\\Meccanica e Meccatronica}
\author{IIS Fermi Sacconi CPIA -- Ascoli Piceno}
\institute{In collaborazione con ITS Academy Tecnologia \& Made in Italy nelle Marche}
...
\begin{frame}{Monte Ore: Quinquennale vs Quadriennale}
	\begin{block}{Monte ore su 5 anni (tradizionale) 26-27}
		\begin{itemize}
			\item 4 anni da 32 ore
			\item 1 anno da 30 ore
			\item 33 settimane per anno
			\item totale ore 5214
		\end{itemize}
...
\end{frame}
	...
	\begin{frame}
		\begin{block}{Rimodulazione su 4 anni}
			\begin{itemize}
				...
				\item 36 h/settimana (in media)× 33 settimane × 4 anni = \textbf{4752 ore frontali}
				\item 5214-4752 = 462		 
			\end{itemize}
		\end{block}
		...
		\begin{alertblock}{Ore da redistribuire}
			\textbf{462 ore} da redistribuire con modalità innovative e flessibili
		\end{alertblock}
	...
	\begin{frame}{Ore da redistribuire}
		...
		\begin{itemize}
			\item Attività pomeridiane e FAD, sincrona/asincrona
			\item FSL potenziata
			\item Attività di progettazione in modalità Service Learning
		\end{itemize}
	\end{frame}
	% Slide 3: Distribuzione delle 528 ore
	\begin{frame}{Distribuzione delle 5214 Ore su 4 Anni}
		\small
		\begin{table}
			\centering
			\begin{tabular}{|l|c|p{9.5cm}|}
				...
				\hline
				\textbf{1° anno} & 1122 & 34h p.sett. + 99* \\
				\hline
				\textbf{2° anno} & 1221 & 37h p.sett (di cui) 2h FAD pom. + 99* \\
				\hline
				\textbf{3° anno} & 1221 & 37h p.sett (di cui) 2h FAD pom. + 66* 	\\
				\hline
				\textbf{4° anno} & 1188 & 36h p.sett (di cui) 2h FAD pom. + 198* \\
				\hline
				\rowcolor{lightgray}
				\textbf{TOTALE ORE EROGATE} & \textbf{5214} & \\ 
				\hline
			\end{tabular}
		\end{table}
		
		\vspace{0.3cm}
		(*) Ore a compensazione / potenziamento erogate in modalità flessibile e innovativa
	...
	\begin{frame}{L'Offerta Formativa Integrata della Filiera}
		...
		\begin{block}{Percorso Quadriennale}
			\textbf{Meccanica, Meccatronica ed Energia} -- Articolazione Meccanica e Meccatronica\\
		\end{block}
		
		\begin{block}{Percorso Biennale ITS}
			\textbf{ITS Academy Tecnologia \& Made in Italy nelle Marche} -- Area Tecnologica 6: Meccatronica\\
			Corso: \textit{Full Stack Developer} (sede Ascoli Piceno)
		\end{block}
	...
	\begin{frame}{L'Offerta Formativa Integrata della Filiera}
		\begin{block}{Prosecuzione universitaria}
			...
			\begin{itemize}
				\item Ingegneria Meccanica, Meccatronica, dell'Automazione
				\item Ingegneria Disegno Industriale
			\end{itemize}
	...
	\begin{frame}{Partner Strategici della Filiera}
		...
		\begin{columns}[t]
			...
			\begin{itemize}
				\item \textcolor{primaryblue}{ITS Academy Tecnologia \& Made in Italy nelle Marche}
				\item Università di Camerino
				\item Università Politecnica Marche
				\item CPIA Ascoli Piceno
				\item Nucleo Protezione Civile e Sisma
			\end{itemize}
			...
			\begin{itemize}
				...
				\item \textcolor{accentorange}{Fortek S.r.l.} (FSL e formazione)
	...
	\begin{frame}{Vantaggi della Filiera 4+2}
		\begin{itemize}
			...
			\item[\checkmark] \textbf{Organico invariato} 
	...
	\begin{frame}{Metodologie Didattiche Innovative}
		\begin{columns}
			...
			\begin{block}{Focus competenze}
				\begin{itemize}
					\item Meccanica e Meccatronica
					\item Automazione Industriale e Robotica
					\item Industry 4.0
					\item Processi Produttivi Industriali
					\item Tecnologie Additive
				\end{itemize}
			\end{block}
		\end{columns}
	\end{frame}
	...
	\begin{frame}{Profili Professionali in Uscita}
		...
		\begin{block}{Profili tecnici}
			\begin{itemize}
				\item {6.1.1  Tecnico superiore per la ``progettazione e la produzione meccatronica avanzata''}
				\item {6.2.2 Tecnico superiore per la ``digitalizzazione dei sistemi e per l'applicazione delle tecnologie abilitanti ai processi industriali''}
			\end{itemize}
		\end{block}
	\end{frame}
	...
	\begin{frame}{Sistema di Monitoraggio e Valutazione}
		\begin{block}{Coordinamento}
			...
			con supporto dell'ITS Academy Tecnologia \& Made in Italy nelle Marche
		\end{block}
	...
	\begin{frame}{Filiera 4+2 Meccanica e Meccatronica: Un Progetto Territoriale}
		\begin{center}
			\Large
