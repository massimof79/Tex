...
\end{frame}
	...
	\definecolor{reactblue}{RGB}{97,218,251}
	\definecolor{reactdark}{RGB}{32,35,42}
	\definecolor{codebg}{RGB}{40,44,52}
	\definecolor{codegreen}{RGB}{152,195,121}
	\definecolor{codepurple}{RGB}{198,120,221}
	
	\setbeamercolor{palette primary}{bg=reactblue,fg=white}
	\setbeamercolor{palette secondary}{bg=reactdark,fg=white}
	\setbeamercolor{structure}{fg=reactblue}
	
	% Configurazione listings con escape
	\lstset{
		language=Java,
		backgroundcolor=\color{codebg},
		...
		breaklines=true,
		frame=single,
		rulecolor=\color{reactblue},
		tabsize=2,
		captionpos=b,
		escapeinside={@}{@},
		morekeywords={const, let, useState, useEffect, export, default, import, from, return, function}
	}
	
	% Informazioni documento
	\title{Introduzione a React.js}
	\subtitle{Libreria JavaScript per Interfacce Utente}
	\author{Prof. Massimo Fraticelli}
